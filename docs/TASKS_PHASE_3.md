...
- [x] 确认第三阶段三条核心主线：OpenClaw、飞书单向通知与微信双向交互、其他 LLM 模型。
- [x] 完成 OpenClaw 与 Chub 关系的前置调研。
- [x] 形成 OpenClaw、微信双通道、其他 LLM 与 Chub 的接入流程初稿。
- [x] 明确 OpenClaw、飞书 Webhook、微信 ClawBot、其他 LLM 与 Chub 的职责和信任边界。
...
- [ ] 完成“微信 ClawBot ↔ OpenClaw ↔ 其他 LLM ↔ Chub/目标电脑”双向交互链路。
