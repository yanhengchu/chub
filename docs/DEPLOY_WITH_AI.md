...
4. 如需要 AI Runtime 或微信任务编排，将 `bundled-modules/` 中的 ZIP 放入 `data/local/artifacts/plugins/codex-runtime/` 或 `data/local/artifacts/plugins/weixin-orchestration/`，再在 Chub 设置页“插件管理”导入与启用；版本选择在对应插件设置页完成。
