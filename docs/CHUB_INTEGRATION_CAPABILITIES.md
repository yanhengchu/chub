...
| 修复与升级 | `chub network restart`；`chub service definitions [--core]`；`chub runtime dependencies`；`chub upgrade service`；`chub upgrade logs`；`chub chrome supervisor reconcile [--restart]` |
